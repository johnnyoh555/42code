...
/*   Updated: 2023/12/10 21:44:51 by jooh             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

static void make_o_pwd(info, char *o_pwd)
{
	int		size;
	int		idx;
	char	**new_ev;
...
static void change_o_pwd(info, char *o_pwd)
{
	int	idx;
...
static void	change_pwd(info, char *n_pwd, char *o_pwd)
{
	int	idx;
